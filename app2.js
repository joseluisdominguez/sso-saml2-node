...
const sp_options = {
  entity_id: "loud-two",
  private_key: fs.readFileSync("certs/private-sp-2.pem").toString(),
  certificate: fs.readFileSync("certs/public-sp-2.pem").toString(),
  assert_endpoint: "https://localhost:4002/assert",
  force_authn: false,
...
.listen(4002, function () {
  console.log('Example app listening on port 4002! Go to https://localhost:4002/')
})